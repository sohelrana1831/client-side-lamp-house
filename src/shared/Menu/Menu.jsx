              ...
              <div className="flex justify-between lg:w-auto  lg:static lg:block lg:justify-start">
                ...
                >
                  <h1 className="text-4xl font-bold uppercase">
                    Lamp
                    <span>
                      <i className="fas fa-menorah text-blue-500 animate-pulse px-2"></i>
                    </span>
                    House
                  </h1>
                </Link>
                        ...
                        <div className="relative">
                          <div className="rounded-full w-40 bg-gradient-to-br from-yellow-200 to-red-500 p-1">
                            <li
                              ...
                              className="bg-white flex items-center  p-1 rounded-full cursor-pointer transform transition "
                            >
