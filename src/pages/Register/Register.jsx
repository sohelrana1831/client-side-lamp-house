...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const userData = { displayName: data.name, email: data.email };
      axios
        .post("https://boiling-badlands-96357.herokuapp.com/user", userData)
        .then((result) => {
        ...
        >
          ...
          >
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              {authError && (
                <span className="text-red-600 text-center py-2">
                  {authError}
                </span>
              )}
